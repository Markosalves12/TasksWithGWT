...
;
_.card_0_g$ = function Axf_g$(title_0_g$, value_0_g$){
  xxf_g$();
  return new T7c_g$('<div class="tf-card"><span class="tf-card-label">' + title_0_g$ + '<\/span>' + '<strong class="tf-card-value">' + value_0_g$ + '<\/strong>' + '<\/div>');
}
;
_.render_6_g$ = function Bxf_g$(total_0_g$, pendentes_0_g$, andamento_0_g$, concluidas_0_g$){
  var pct_0_g$;
  this.cards_1_g$.clear_0_g$();
  this.cards_1_g$.add_4_g$(this.card_0_g$('Total de tarefas', total_0_g$));
  this.cards_1_g$.add_4_g$(this.card_0_g$('Pendentes', pendentes_0_g$));
  this.cards_1_g$.add_4_g$(this.card_0_g$('Em andamento', andamento_0_g$));
  this.cards_1_g$.add_4_g$(this.card_0_g$('Conclu\xEDdas', concluidas_0_g$));
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/MyWebApp/EAB6383E8822C49AF418E8C744677FBD_sourcemap.json 

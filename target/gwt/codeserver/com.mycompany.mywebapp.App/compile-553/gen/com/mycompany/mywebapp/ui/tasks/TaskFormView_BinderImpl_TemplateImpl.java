...
public class TaskFormView_BinderImpl_TemplateImpl implements com.mycompany.mywebapp.ui.tasks.TaskFormView_BinderImpl.Template {
...
sb.append("'>Descrição</span> <span id='");
...
sb.append("'>Categoria</span> <span id='");
...
sb.append("'>Prioridade</span> <span id='");
...
sb.append("'>Responsável</span> <span id='");
